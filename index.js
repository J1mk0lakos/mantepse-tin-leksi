            ...
            if (userWord.length == 5){
                if (userWord === userWord.toUpperCase()){
                    ...
                    if (userWord==randomWord){
                        ...
                        if (tries == 1){
                            word1(randomWord, userWord);
                        } else if (tries == 2){
                            word2(randomWord, userWord);
                        } else if (tries == 3){
                            word3(randomWord, userWord);
                        } else if (tries == 4){
                            word4(randomWord, userWord);
                        } else if (tries == 5){
...
var word1 = function(randomWord, userWord){
...
var word2 = function(randomWord, userWord){
    var rightWord1 = randomWord.charAt(0)
    var rightWord2 = randomWord.charAt(1)
    var rightWord3 = randomWord.charAt(2)
    var rightWord4 = randomWord.charAt(3)
...
var word3 = function(randomWord, userWord){
    var rightWord1 = randomWord.charAt(0)
    var rightWord2 = randomWord.charAt(1)
    var rightWord3 = randomWord.charAt(2)
    var rightWord4 = randomWord.charAt(3)
...
var word4 = function(randomWord, userWord){
    var rightWord1 = randomWord.charAt(0)
    var rightWord2 = randomWord.charAt(1)
    var rightWord3 = randomWord.charAt(2)
    var rightWord4 = randomWord.charAt(3)
...
var word5 = function(randomWord, userWord){
    var rightWord1 = randomWord.charAt(0)
    var rightWord2 = randomWord.charAt(1)
    var rightWord3 = randomWord.charAt(2)
    var rightWord4 = randomWord.charAt(3)
